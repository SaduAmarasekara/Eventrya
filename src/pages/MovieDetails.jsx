...
{show.movie.vote_average.toFixed(1)} User Rating
          ...
          <p className='text-gray-400 mt-2 text-sm leading-tignt max-w-xl'>{show.movie.overview}</p>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            <button className='flex items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-'>
